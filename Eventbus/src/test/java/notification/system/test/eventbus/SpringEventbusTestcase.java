package notification.system.test.eventbus;
...
import com.trackorder.domain.model.DomainEventPublisher;
import org.springframework.context.ApplicationContext;
import com.trackorder.application.OrderDispatchedApplicationService;
...
public class SpringEventbusTestcase{
	...
	public void springEventBusVerboseSubscribeTest() {
		...
		ApplicationContext context = new ClassPathXmlApplicationContext("/META-INF/notification/system/spring-eventbus-verbose-trackorder-subscribe-ctxt.xml");
	...
	private void testEventBus(ApplicationContext context){				
		...
		OrderDispatchedApplicationService applicationService = context.getBean(OrderDispatchedApplicationService.class);
		applicationService.updatePayment();
		applicationService.updateOrderDispatched();
